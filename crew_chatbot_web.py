...
import uuid
import json
from crew_chatbot import load_agents, CrewAgent, CONFIG_PATH, LOG_PATH
...
if not agents:
    raise RuntimeError("No agents loaded. Please check your configuration and ensure at least one agent is defined.")
...
def chat():
    ...
    return render_template_string(CHAT_TEMPLATE, agents=agents, current_agent=current_agent, history=history)
